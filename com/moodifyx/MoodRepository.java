...
public class MoodRepository {
    ...
    private void initializeMoodSongs(){
        Map<String, String[]> moodFiles = Map.of(
          ...
          "Mysterious", new String[]{"mysteriousgirl.wav","myseriousgirlie.wav"},
          ...
          "Peacceful", new String[]{"peacefulgirl.wav","peacefulgirlie.wav"},
    ...
    private String formatTitle(String fileName){
      ...
      public List<Song> getSongsforMood(String mood){
        return moodSongs.getOrDefault(mood, List.of(new Song("Default Vibe",
        "music/happygirl.wav")));
      }
